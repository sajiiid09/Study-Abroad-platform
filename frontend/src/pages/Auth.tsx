            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="w-full pl-12 pr-12 py-3 rounded-lg border border-border bg-background focus:outline-none focus:ring-2 focus:ring-primary/20 transition-all"
                  placeholder="••••••••"
                />
                <button
                  type="button"
        ...
        <div className="absolute inset-0 flex items-center justify-center p-12">
          ...
          >
            ...
            <p className="text-primary-foreground/80 text-lg max-w-md mx-auto">
              Join 50,000+ students who have achieved their study abroad dreams with GlobalStudy.
            </p>
          </motion.div>
        </div>
      </div>
